...
class PayloadRepository(private val context: Context) {
    ...
    companion object {
        private const val COMMIT_API_URL =
            "https://api.github.com/repos/BLAndroidGIT/Root-My-Galaxy-Payloads/git/ref/heads/main"
        private const val RAW_REPOSITORY =
            "https://raw.githubusercontent.com/BLAndroidGIT/Root-My-Galaxy-Payloads"
